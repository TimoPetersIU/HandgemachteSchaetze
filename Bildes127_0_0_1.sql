...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 07. Nov 2023 um 15:50
...
-- Datenbank: `menschen`
--
CREATE DATABASE IF NOT EXISTS `menschen` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `menschen`;
...
INSERT INTO `menschen` (`Name`, `Alt`, `Geschlecht`, `Wohnort`) VALUES
('Hanz', 21, 'M', 'Brandenburg'),
('Hanz', 21, 'M', 'Brandenburg'),
('Haniz', 21, 'w', 'Brandenburg'),
('Hanz', 21, 'M', 'Brandenburg'),
('Haniz', 21, 'w', 'Brandenburg'),
('Hanz', 21, 'M', 'Brandenburg'),
('Haniz', 21, 'w', 'Brandenburg'),
...
('root', '[{\"db\":\"menschen\",\"table\":\"menschen\"},{\"db\":\"menschen\",\"table\":\"Menschen\"}]');
...
('root', '2023-10-23 13:58:20', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"de\"}');
